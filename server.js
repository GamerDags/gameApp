...
app.get('/', (req, res) => {
  ...
  if(req.query.first_release_date) query += `&filter[first_release_date][in]=${req.query.first_release_date}`;
...
let url = `https://api-2445582011268.apicast.io/games/?fields=name,genres,platforms,esrb.rating,first_release_date,esrb${query}&limit=25`;
console.log (url);
